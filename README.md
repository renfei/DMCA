...
The notice must contain all elements required by the U.S. Digital Millennium Copyright Act (17 U.S.C. § 512), including
but not limited to:
...
- A statement that the information in the notice is accurate and, under penalty of perjury, that you are authorized to
...
RENFEI.NET operates an open BitTorrent tracker (http://tracker.renfei.net:8080/announce) for technical testing and
research purposes.

**Important facts about the tracker**:

- The tracker **does not host, store, or transmit** any torrent files or copyrighted content.
- The tracker only provides a simple list of peer IP addresses and ports to help BitTorrent clients connect with each
  other.
